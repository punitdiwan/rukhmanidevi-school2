                ...
                <div>
                  ...
                  <div>
                    ...
                    <h6 style={{ color: "#5b5b5b", fontSize: "17px" }}>
                      ...
                      interactive classrooms with SMART BOARDS, networked
                      computers and DLP Projectors. Many classrooms have
                      Visualizers as well. The computers are networked on LAN
                      and there is a huge repository of educational software, in
                      various subjects and practically for every chapter in the
                      course of study, available on the school servers. The
                      classrooms are fitted with the latest and best equipment
                      available so that the children get the best teaching aids
                      to assist in making the teaching learning process most
                      effective, through computer-aided-teaching (CAT). The
                      children and teachers alike take keen interest in the
                      beautification and adornment of their classrooms. To
                      achieve the highest levels of academic excellence the
                    ...
                    <div className="row">
                      ...
                      <div className="col-sm-12">
                        <h6 style={{ color: "#5b5b5b", fontSize: "17px" }}>
                          ...
                          integrated science course at the secondary school
                          stage, and for the Physics, Chemistry and Biology
                          practicals at the Senior Secondary Stage, as per the
                          requirement of the new curricula and scheme of
                          studies, laid down by the CBSE. The students
