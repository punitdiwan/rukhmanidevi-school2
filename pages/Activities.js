            ...
            <div className='activity'>
                <div className='container'>
                    <div className='activitycontent'>
                        ...
                        <h6><b style={{ color: 'black' }}>Co-curricular activities</b> like Music (Indian, Vocal and Instrumental),Photography, Art, Craft, Painting, Macrame, Stitching, Knitting, Embroidery, Gardening, Mass PT, Gymnastics, Band (Brass and Pipe) and Karate are offered in the school curriculum.</h6>
                        <h6>Extra-curricular activities like Dance, Drama, Debates, Declamations, Quiz, Recitations, Parade, Camps and Excursions are also incorporated in the calendar and are conducted under the supervision of teachers.</h6>
                        ...
                        <h6>Pupils are regularly sent to participate in Inter-School competitions as well.
                        ...
                        <h6>Outdoor camps, treks and tours are organized every year to give the children an opportunity to see the interiors of Himachal Pradesh and Uttaranchal and to get some educational and recreational exposure.</h6>
                        <h6>These outdoor and adventure activities are important as they offer the children experiences to face the hardships and challenges of life and would also inculcate in them a spirit of adventure and love for wildlife and nature.</h6>
                        <h6>Camps also provide a splendid opportunity for the teachers to get to know their children better and to understand the other facets of their personality difficult to observe in the classroom.</h6>
                        <h6>Likewise, children also learn to communicate with each other and their teachers on a more informal level.</h6>
