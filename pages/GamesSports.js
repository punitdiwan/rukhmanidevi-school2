      ...
      <div className="container-fluid media_top">
        <div className="container">
          ...
          <div className="row">
            <div className="col-sm-12">
              ...
              <p style={{ color: "#5b5b5b", fontSize: "17px" }}>
                ...
                Government of India, Delhi are strictly adhered to and followed.
                The children are prepared to sit for the All India Secondary and
                Senior Secondary School Examinations, conducted by the CBSE,
                Delhi. The syllabus provides for and examines a student in
                English, Hindi, Mathematics, Science (with Practicals), and
          ...
          <div className="row">
            {slides1.map((item, i) => {
              return (
                <div className="col-sm-3 then-img">
                  <img
                    src={item.title}
                    alt="Avatar"
            ...
            <div className="col-sm-12">
              <h4 style={{ color: "#0063a6" }}>
                <b> Playfields and Playing Courts:</b>
              </h4>
              <p style={{ color: "#5b5b5b", fontSize: "17px" }}>
                ...
                Mathematics are also available as optional subjects. All
              ...
              <div className="row">
                ...
                <div>
                  <p style={{ color: "#5b5b5b", fontSize: "17px" }}>
                    ...
                    learning. To achieve the highest levels of academic
                    excellence the school maintains a class-section average
                    strength of just 25 pupils in junior classes and 30 pupils
                    in senior classes.
                  </p>
                  <div className="row">
                    <div className="px-4 col-sm-6">
                      <span className="d-flex">
                        <DirectionsRunIcon
                          style={{ color: "#0a7ad1", fontSize: "30px" }}
                        />
                        <p className="mt-1">
                          <b>A national sized Swimming Pool</b>
                        </p>
                      </span>
                      {/* <span className="d-flex" >
                                                <DirectionsRunIcon style={{ color: "#0a7ad1", fontSize: "30px" }} />
                                                <p className="mt-1"><b>A national sized Swimming Pool</b></p>
                                            </span>
                                            <span className="d-flex" >
                                                <DirectionsRunIcon style={{ color: "#0a7ad1", fontSize: "30px" }} />
                                                <p className="mt-1"><b>A national sized Swimming Pool</b></p>
                  ...
                  <h4 style={{ color: "#0063a6" }}>
                    <b>Inter-House and Inter-School Games and Sports:</b>
                  </h4>

                  <p style={{ color: "#5b5b5b", fontSize: "17px" }}>
                    The classrooms are very modern, large and airy with proper
                    lighting and provide the most conducive atmosphere for
                    learning. All secondary classes in Pinegrove are interactive
                    classrooms with SMART BOARDS, networked computers and DLP
                    Projectors. Many classrooms have Visualizers as well. The
                    computers are networked on LAN and there is a huge
                    repository of educational software, in various subjects and
                    practically for every chapter in the course of study,
                    available on the school servers. The classrooms are fitted
                    with the latest and best equipment available so that the
                    children get the best teaching aids to assist in making the
                    teaching learning process most effective, through
                    computer-aided-teaching (CAT). The children and teachers
                    alike take keen interest in the beautification and adornment
                    of their classrooms. To achieve the highest levels of
                    academic excellence the school maintains a class-section
                    average strength of just 25 pupils in junior classes and 30
                    pupils in senior classes.
                  </p>
