...
const generalInfo = [
    ...
    { no: 4, label: 'COMPLETE ADDRESS WITH PIN CODE', value: 'NH-46 Bhopal – Narsinghgarh Road, Near Jharkheda Tahsil Shyampur District Sehore (M.P)  Pin No. 466661' },
    { no: 5, label: 'PRINCIPAL NAME & QUALIFICATION', value: 'Mrs. Suman Yadav (M.Sc,B.Ed)' },
    { no: 6, label: 'SCHOOL EMAIL ID', value: 'rukhmanidevischool@gmail.com, 50585@cbseshiksha.in' },
    { no: 7, label: 'CONTACT DETAILS (LANDLINE/MOBILE)', value: '8878954637, 9993392708' },
]
const resultX = [
...
const schoolInfra = [
    { sno: '1', info: 'TOTAL CAMPUS AREA OF THE SCHOOL (IN SQUARE MTR)', details: '8255.58 Sq.mtrs.' },
    { sno: '2', info: 'NO. AND SIZE OF THE CLASS ROOMS (IN SQ MTR)', details: '24 & 1115' },
    { sno: '3', info: 'NO. AND SIZE OF LABORATORIES INCLUDING COMPUTER LABS (IN SQ MTR)', details: '4' },
    { sno: '3', info: 'Physics Lab', details: '1' },
    { sno: '3', info: 'Chemistry Lab', details: '1' },
    { sno: '3', info: 'Biology Lab', details: '1' },
    { sno: '3', info: 'Computer lab', details: '1' },
