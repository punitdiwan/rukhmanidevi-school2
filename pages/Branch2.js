                    ...
                    <div className='info'>
                        <div className='director'>
                            <div className='directorinfo' sm='8'>
                                <div className=''>
                                    <h3>{director_data?.data?.length > 0 ? director_data?.data[1]?.message : "Airport Road Branch"}</h3>
                            ...
                            <div className='directorimg' sm='4'>
                                <div className='thennow'>
                                    <img src={director_data?.data?.length > 0 ? director_data?.data[1]?.photo?.data?.full_url : "/images/a2.jpg"}
                                        alt='director' style={{ width: "110%", height: "350px" }} />
                                    <h2 className="text-center">
                                        <b> {director_data?.data?.length > 0 ? director_data?.data[1]?.full_name : "Airport Road principal"} </b>
                                    </h2>
