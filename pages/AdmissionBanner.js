...
const AdmissionBanner = () => {
    ...
    const getdata = async () => {
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/${process.env.NEXT_PUBLIC_SCHOOL}/items/admission_banner?fields=*.*.*`);
                ...
                >
                    ...
                    <div
                        style={{
                            ...
                            width: '80%', // Use 90% width for responsiveness
                            maxWidth: '400px', // Adjusted max width for larger images
                            padding: '0',
                            textAlign: 'center',
                            minHeight: '30vh', // Allow modal height to adjust based on content
                            maxHeight: '93vh', // Limit the height for larger screens
                            overflow: 'hidden',
                        }}
                    >
                        {/* Close button */}
                        ...
                        <img
                            ...
                            style={{
                                width: '100%',
                                height: '80%', // Use 100% of the modal height
                                objectFit: 'fill', // Ensures image scales well within the container
                                borderRadius: '8px',
                            }}
                        />
                    </div>
